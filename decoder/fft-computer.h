...
// First implemented in https://github.com/funcwj/asr-utils/blob/master/fft/fft-computer.h
// Modified 2018.7
...
public:
    ...
    // num_samples: length of cplx_values(N) and register_size_ == num_samples >> 1
    // invert: for inverse FFT, invert = true
