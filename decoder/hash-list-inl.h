...
#ifndef HASH_LIST_INL_H
#define HASH_LIST_INL_H

// Do not include this file directly.  It is included by hash-list.h
...
HashList<I, T>::~HashList() {
  ...
  if (num_in_list != num_allocated) {
    LOG_WARN << "Possible memory leak: " << num_in_list << " != " << num_allocated
